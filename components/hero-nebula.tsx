...
export default function HeroNebula({
  ...
  return (
    <section className="hero-nebula">
      ...
      <div 
        className="hero-overlay relative z-20 h-full flex flex-col justify-between items-center w-full pt-[40px] px-5 pb-[120px] md:pt-[80px] md:pb-[40px]"
      ...
      >
        ...
        <div className="hero-content-bottom">
          <div className="hero-actions flex flex-row justify-between items-center w-full max-w-7xl mx-auto text-base sm:text-lg px-3 xs:px-6 md:px-12 gap-2 sm:gap-4 -mt-[35px]">
