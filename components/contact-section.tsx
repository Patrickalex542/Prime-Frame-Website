      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="relative z-20 flex flex-wrap items-center justify-center gap-6 sm:gap-10">
              <a href="mailto:contact@primeframe.ro" className="socialContainer containerZero scale-125 hover:scale-[1.35] transition-transform" aria-label="Email">
                <Mail className="socialSvg !fill-transparent text-white" />
              </a>
              <a href="https://www.instagram.com/primeframe.ro?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="socialContainer containerOne scale-125 hover:scale-[1.35] transition-transform" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@primeframe.ro" target="_blank" rel="noopener noreferrer" className="socialContainer containerTwo scale-125 hover:scale-[1.35] transition-transform" aria-label="TikTok">
              ...
              <a href="#" className="socialContainer containerThree scale-125 hover:scale-[1.35] transition-transform" aria-label="Facebook">
                <div>
              ...
              <a href="https://wa.me/40763481568" className="socialContainer containerFour scale-125 hover:scale-[1.35] transition-transform" aria-label="WhatsApp">
