      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            {/* Roajuan93 Style Icons */}
            <a href="mailto:contact@primeframe.ro" className="social-btn mail w-10 h-10 group" aria-label="Email">
              <Mail className="w-5 h-5" />
            </a>
            <a href="https://www.instagram.com/primeframe.ro?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="social-btn insta w-10 h-10 group" aria-label="Instagram">
              <Instagram className="w-5 h-5" />
            </a>
            <a href="https://wa.me/40763481568" className="social-btn wa w-10 h-10 group" aria-label="WhatsApp">
