        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 lg:gap-12">
            ...
            <div className="flex items-center gap-3 ml-4 border-l border-border pl-4">
              ...
              <a href="#" className="socialContainer containerTwo" aria-label="TikTok">
                <svg className="socialSvg tiktokSvg largeIcon" viewBox="0 0 48 48">
                  <path
              ...
              <a href="#" className="socialContainer containerThree" aria-label="Facebook">
                <div>
                  <svg className="socialSvg tiktokSvg largeIcon" width="44px" height="44px" viewBox="0 0 45 35">
                    <path
          ...
          <div className="md:hidden -mt-[6px]">
            <label className="hamburger">
              ...
              <svg viewBox="0 0 32 32" style={{ stroke: 'white' }}>
                <path className="line line-top-bottom" d="M27 10 13 10C10.8 10 9 8.2 9 6 9 3.5 10.8 2 13 2 15.2 2 17 3.8 17 6L17 26C17 28.2 18.8 30 21 30 23.2 30 25 28.2 25 26 25 23.8 23.2 22 21 22L7 22" style={{ stroke: 'white' }}></path>
                <path className="line" d="M7 16 27 16" style={{ stroke: 'white' }}></path>
              </svg>
            </label>
          </div>
        </div>
